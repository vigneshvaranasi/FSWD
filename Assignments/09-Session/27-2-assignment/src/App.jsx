...
function App(){
  let Data =[
    ...
    {name: 'Mehul Kothari',heading:"COVOID 19 Tracker (Statistics) app using Angular",des:"COVID 19 Tracker (Statistics) app using Angular Dark Mode Introduction Everyone is aware",date:"Apr 04, 2020 08:46",banner:india,profile:profilepic},
